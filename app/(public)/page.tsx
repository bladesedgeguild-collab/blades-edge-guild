  ...
  return (
    <div className="min-h-screen flex flex-col" style={{ backgroundColor: '#0a0f1e' }}>
      ...
      <section className="flex-1 flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        <p className="text-lg sm:text-xl mb-12" style={{ color: '#6b7a99' }}>
          Burning Crusade Classic — Dreamscythe Alliance
        </p>
        ...
        <div className="w-full max-w-5xl mb-16">
          <h2 className="text-sm font-semibold uppercase tracking-widest mb-4" style={{ color: '#6b7a99' }}>
            Roster Preview
          </h2>
        ...
        <Link
          href="/login"
          className="inline-flex items-center gap-2 px-8 py-3 rounded-md font-semibold text-white transition-all duration-200 hover:opacity-90 hover:scale-105"
        ...
        >
          ...
          Login with Discord to Register Your Return
        </Link>
      </section>
    </div>
  )
